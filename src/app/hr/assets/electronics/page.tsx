      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Electronics Management</h1>
              <p className="text-gray-600">Manage employee electronic devices</p>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-xl font-semibold text-gray-900">60</p>
              </div>
            </div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-sm">
              ...
              {electronics.map((device) => (
                <tr key={device.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">{device.employeeName}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{device.issueDate}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
