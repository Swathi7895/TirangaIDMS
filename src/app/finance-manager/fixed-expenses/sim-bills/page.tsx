...
export default function SimBillsPage() {
  const [expenses, setExpenses] = useState<SimBillExpense[]>([
    { id: 1, date: '2023-10-10', amount: 30.00, description: 'October Bill' },
    { id: 2, date: '2023-11-10', amount: 30.00, description: 'November Bill' },
    { id: 3, date: '2023-12-10', amount: 30.00, description: 'December Bill' },
  ]);
  ...
  const handleAddExpense = () => {
    ...
    const expenseToAdd: SimBillExpense = {
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">{editingId ? 'Edit SIM Bill' : 'Add New SIM Bill'}</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          ...
          <input
            type="text"
            name="description"
            placeholder="Description / Billing Period"
